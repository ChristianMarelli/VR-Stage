...
namespace Oculus.Voice.Demo
{
    public class LogHandler : MonoBehaviour
    {
        ...
        [SerializeField] private TMP_InputField Psw;
        [SerializeField] private TMP_InputField User;
        
        [SerializeField] private Image PswMic;
        [SerializeField] private Image UserMic;
         private Image mic;
        [SerializeField] private bool isPsw;
        ...
        // Toggle activation
        // Modifica il colore dell'icona appartenente al bottone premuto e invoca la funzione che attiva la registrazione 
        public void ToggleActivation(bool isPsw)
        {
